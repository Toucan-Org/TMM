...
class InstallDirectoryFrame(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        #check if an install_path is saved in the config file
        ...
        self.install_location = customtkinter.CTkEntry(self, placeholder_text="Enter KSP 2 Install Directory...")
...
class LaunchButton(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.launch_image_hover = customtkinter.CTkImage(Image.open("./data/images/launch_button/launch_button_hover2.png"), size=(200, 80))
        self.grid_columnconfigure(0, weight=1)
